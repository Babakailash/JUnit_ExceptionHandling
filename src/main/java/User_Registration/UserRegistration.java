...
public class UserRegistration {
    ...
    public boolean CheckFirstName(String firstName) throws UserRegistrationException {
        ...
        if(result) {
            ...
            throw new UserRegistrationException(result + "Invalid First Name");
        }
        return result;
    }
    ...
    public boolean CheckLastName(String lastName) throws UserRegistrationException {
        ...
        if(result) {
            ...
            throw new UserRegistrationException(result + "Invalid Last Name");
        }
        return result;
    }
    ...
    public boolean Email(String email) throws UserRegistrationException {
        ...
        if(result) {
          ...
          throw new UserRegistrationException(result + "Invalid Email");
        }
        return result;
    }
    ...
    public boolean PhoneNumber(String phoneNumber) throws UserRegistrationException {
        ...
        if(result) {
           ...
           throw new UserRegistrationException(result+ "Invalid Phone Number");
        }
        return result;
    }
    ...
    public boolean Password(String password) throws UserRegistrationException{
        ...
        if(result) {
           ...
           throw new UserRegistrationException(result+ "Invalid Password");
        }
        return result;
    }
}